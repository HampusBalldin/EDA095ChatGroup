...
public enum MessageType {
	...
	REQUEST_RECEIVE_DATA("Request_Receive_Data"), @XmlEnumValue("Request_Send_Data")
	REQUEST_SEND_DATA("Request_Send_Data"), @XmlEnumValue("Login")
	LOGIN("Login"), @XmlEnumValue("Logout")
	LOGOUT("Logout"), @XmlEnumValue("GetFriends")
